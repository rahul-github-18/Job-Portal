...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                List<RecruiterJobsDto> recruiterJobs = jobPostActivityService.getRecruiterJobs(((RecruiterProfile) currentUserProfile).getCompany());
    ...
    public String globalSearch(Model model,
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            model.addAttribute("username", currentUsername);
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                // Keep the searched jobPost list for recruiters
            } else {
                List<JobSeekerApply> jobSeekerApplyList = jobSeekerApplyService.getCandidatesJobs((JobSeekerProfile) currentUserProfile);
                List<JobSeekerSave> jobSeekerSaveList = jobSeekerSaveService.getCandidatesJob((JobSeekerProfile) currentUserProfile);
    ...
    public String addJobs(Model model) {
        ...
        if (currentUserProfile instanceof RecruiterProfile) {
            ...
            if (jobPostActivity.getJobCompanyId() == null) {
                jobPostActivity.setJobCompanyId(new com.jobportal.entity.JobCompany());
            }
            jobPostActivity.getJobCompanyId().setName(recruiterProfile.getCompany());
        }
