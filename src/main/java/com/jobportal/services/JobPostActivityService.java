...
public class JobPostActivityService {
    ...
    public List<RecruiterJobsDto> getRecruiterJobs(String company) {

        List<IRecruiterJobs> recruiterJobsDtos = jobPostActivityRepository.getRecruiterJobs(company);
        ...
        for (IRecruiterJobs rec : recruiterJobsDtos) {
            ...
            recruiterJobsDtoList.add(new RecruiterJobsDto(rec.getTotalCandidates(), rec.getJob_post_id(),
                    rec.getJob_title(), loc, comp, rec.getSalary(), rec.getJob_type(), rec.getPosted_date(), rec.getIs_active()));
        }
    ...
    public List<JobPostActivity> getAll() {
        return jobPostActivityRepository.findAllValid();
    }
